...
| `.team-project/scrum-master/sprint-backlog.md` | [`roles/scrum-master/templates/sprint-backlog.md`](../../roles/scrum-master/templates/sprint-backlog.md) | SM | **Sim — estrutura**; as linhas — inclusive o Registro de transições (R24) — são do projeto |
...
| **Estrutura + conteúdo local** | Cabeçalho, colunas e seções vêm do modelo; as linhas são do projeto (`sprint-backlog`, `product-backlog`, `evidence`, `README` §8) | **Mostra o delta da estrutura e pede aprovação** — nunca sobrescreve conteúdo do projeto |
