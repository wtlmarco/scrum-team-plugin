...
Respondo por **como o usuário atravessa o sistema**. Não decido o que o produto faz, nem como o código é estruturado — mas nenhum item com interface entra em construção sem passar por mim.
...
| **Entradas** | Requisito e critério de aceite do PO, inventário de telas e convenções do projeto, telas existentes que o item toca |
...
| **Não faz** | Decidir requisito ou regra de negócio, definir estrutura de código, implementar produção, mexer em tela fora do item |
...
- O que descobri fora do item virou registro, não mudança silenciosa.
