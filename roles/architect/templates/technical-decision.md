...
- [ ] **Defeito no standard** (contradição, lacuna, regra inverificável em `${CLAUDE_PLUGIN_ROOT}/standards/`) → decidir agora para destravar a Task **e** entrar na fila do próximo `/review` — R16
