...
| **UX** | `roles/user-experience/` — roteiro, skills e modelos (jornada, tela, revisão de usabilidade), incluindo os **seis estados** e a lista de critérios de acessibilidade verificáveis que vivem nesses modelos; o entregável que possui — `deliverables/prototype/` (protótipo funcional e seu registro de verificação) |
